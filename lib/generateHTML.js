      ...
      <div class="row">
        ...
        <div class="card" style="width: 18rem;">
         ...
         <ul class="list-group list-group-flush">
          ...
          <li class="list-group-item">Email: <a href = "mailto:${teamInfo[0].email}"><span>${teamInfo[0].email}</span></a></li>
          <li class="list-group-item">Office Number: <span>${teamInfo[0].officeNumber}</span></li>
         </ul>
        </div>
  ...
  for(i = 0; i< teamInfo.length; i++){
    ...
    if(teamInfo[i].getRole() === 'Engineer'){
      ...
      <ul class="list-group list-group-flush">
        ...
        <li class="list-group-item">Email: <a href = "mailto:${teamInfo[i].email}"><span>${teamInfo[i].email}</span></a></li>
        <li class="list-group-item">GitHub Username:<a href="https://github.com/${teamInfo[i].github}"><span>${teamInfo[i].github}</span></a> </li>
      </ul>
    </div>
    </div>`
    }
